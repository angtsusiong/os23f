...
ArrayStack::~ArrayStack() { delete[] stack; }
...
bool ArrayStack::Full() { return (top == size); }
...
bool ArrayStack::Empty() { return (top == 0); }
...
ListStack::~ListStack() { delete stack; }
...
void ListStack::Push(int value) { stack->Prepend(value); }
...
bool ListStack::Empty() { return stack->Empty(); }
